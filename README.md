...
| If you want… | Go here |
|---|---|
| To read about her gently | [The project page →](https://thu-sage.github.io/syll/) |
...
- `syll wake` as the main local runtime, with a terminal dashboard for services, logs, and inline chat
- a browser workbench for chat, model config, channels, schedules, skills, memory, and recorded workflows
